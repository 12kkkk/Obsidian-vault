---
title: Git 详细安装教程（详解 Git 安装过程的每一个步骤）_git安装-CSDN博客
source: https://blog.csdn.net/mukes/article/details/115693833
author:
  - "[[成就一亿技术人!]]"
  - "[[hope_wisdom 发出的红包]]"
published:
created: 2025-08-30
description: 文章浏览阅读10w+次，点赞1.4w次，收藏2.4w次。Git 是个免费的开源分布式版本控制系统，下载地址为git-scm.com 或者 gitforwindows.org，本文介绍 2025/2/10 最新更新的 Git-2.48.1-64-bit.exe 版本的安装方法，本文 120w+ 阅读量，2W+收藏，值得一看。_git安装
tags:
  - clippings
---
> 📢博客主页：https://blog.csdn[.net](https://so.csdn.net/so/search?q=.net&spm=1001.2101.3001.7020) /mukes  
> 📢欢迎点赞👍收藏⭐留言📝如有错误敬请指正！  
> 📢本文由 mukes 原创，首发于 csdn

***更新日志***  
***时间：2025-2-10***  
***内容：更新 `Git-2.48.1-64-bit` 版本安装步骤***

***时间：2023-3-17***  
***内容：更新 `Git-2.40.0-64-bit.exe` 版本安装步骤***

***时间：2022-3-29***  
***内容：更新 `Git-2.35.1.2-64-bit.exe` 版本安装步骤***

***时间：2021-4-17***  
***内容：更新 `Git-2.31.1-64-bit.exe` 版本安装步骤***
...
双击下载后的 `Git-2.48.1-64-bit.exe` ，开始安装，这个界面主要展示了 GPL 第 2 版协议 [^1] 的内容，点击 \[next\] 到第二步。 ![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/d9d6a041231f4c61885a8f5dffdcd801.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/b29dca4d4b594f45919c1e36c054c476.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/f36cd7a22a9b459fa252573f7da798d6.png)

`注：倒数第二个选项打勾的话，需要下载 Windows Terminal 配合 Git Bash使用` ，如图：  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/b6e106d74ac2c33b973bf0443edc636a.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/1ed2469ba36e41de8afd28ed95430e66.png)

安装成功后在开始菜单里的图如下：  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/563fc05b6139148307632f9a1901c166.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/98938e069f7f4105ab98e5d6cbb17c35.png)

如果你不想用 `Vim` 当默认编辑器，换一个，比如 `Notepad++` ，那么你者需要点击下面的蓝色字体 " Notepad ++ " 去其官网下载安装好才能进行下一步 \[next\].

![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/cd5a8a7935344f1e930496397ce4b026.png)

安装后还要配置在 `我的电脑->属性->高级系统设置->高级->环境变量->系统变量->Path->编辑添加` Notepad++ 的安装地址，如 **`C:\Program Files\notepad++`**.  
这样才能在 [Git Bash](https://so.csdn.net/so/search?q=Git%20Bash&spm=1001.2101.3001.7020) 里面直接调用 Notepad++.
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/4548b37a855e4ad6b923e027d07b9b97.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/ca6db926b6f6417db54c56bf9122f78f.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/d3211a475776462b819997462adca71a.png)
...
`注2：选项1为使用 Git 自带的 OpenSSH，选项2为使用系统上的外部 OpenSSH，普通用户建议选项1)`
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/a6afe4e0307248778843985fb39158be.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/0d087b7f67f34cbd805ec806e49319d0.png)
...
引用 《 [GitHub入门与实践](https://book.douban.com/subject/26462816/) 》 第 50 页内容 [^2]
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/7906af0e0d0104617fa8830d613328e3.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/89fdb3c245e448cd9b3df88d5c3b7def.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/e322cfe10a764dfea5df0920c8d71637.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/6a9f2564559a3e201cfadc31e5f1b2f9.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/d62a3657558a4b29bdb59c6cbd69cc7f.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/182ea448ca8fdd81d341aa34b6e1f512.png)
...
点击 \[install\] 进行安装。  
`安装中...`  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/01af71f2ecf0fce0273cfe1dcf9b9880.png)

…  
…  
…  
`安装成功`  
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/dcaf04afbdf7478b88cc9f87894ec0bc.png)
...
这是安装成功后开始菜单里面的图。  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/1c82eb761ed649a11f95c5c25f31a979.png)  
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/